...
def print_intron(file):
                ...
                if obj_type == 'mRNA' :
                    if len(transcripts_pos) > 2:
                        if first_gene == False:
                            ...
                            if last_exon_strand == '+':
                                print str(transcripts_pos[2] - transcripts_pos[1]) + '\t' + str(1)
                            if last_exon_strand == '-':
                                print str(transcripts_pos[(-2)] - transcripts_pos[(-3)]) + '\t' + str(-1)
                    transcripts_pos = []
                    first_gene = False 
    ...
    if len(transcripts_pos) > 2:
        if last_exon_strand == '+':
            print str(transcripts_pos[3] - transcripts_pos[2]) + '\t' + str(1)
        if last_exon_strand == '-':
            print str(transcripts_pos[(-2)] - transcripts_pos[(-3)]) + '\t' + str(-1)
